...
## Runs
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L491)
```python
...
### Run.create
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L658)
```python
...
### Run.update
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L740)
```python
Run.update(self)
```
...
### Run.file
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L812)
```python
Run.file(self, name)
```
...
### Run.history
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L823)
```python
Run.history(self,
            samples=500,
            keys=None,
...
### Run.scan_history
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L855)
```python
...
### Sweep.get
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1017)
```python
Sweep.get(client,
          entity=None,
          project=None,
...
## File
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1113)
```python
...
## Reports
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1192)
```python
...
## QueryGenerator
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1256)
```python
QueryGenerator(self)
```
...
## BetaReport
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1355)
```python
